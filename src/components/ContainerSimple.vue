...
const emit = defineEmits(['updateChartData', 'resetFilters', 'addSite']);
    ...
    <div class="border border-dark p-4 rounded-md flex flex-col" x-data="{ openContainer: true }">
        <div class="flex flex-row justify-between items-center">
            ...
            <div class="flex flex-row gap-3 items-center">
                ...
                <a class="btn primary flex flex-row gap-2 items-center" x-on:click="openContainer = true" @click="$emit('resetFilters')" v-if="props.resetFilters">
                    Reset Filters
                </a>
